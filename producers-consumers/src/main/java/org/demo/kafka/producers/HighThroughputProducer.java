...
public class HighThroughputProducer {
    ...
    private final static Logger logger = LoggerFactory.getLogger(org.demo.kafka.producers.HighThroughputProducer.class.getName());
    ...
    private Properties buildProducerConfig() throws IOException{
        ...
        //for creating idempotent producer, these settings are essential
        ...
        producerProperties.put(ProducerConfig.LINGER_MS_CONFIG,"30");
        producerProperties.put(ProducerConfig.BATCH_SIZE_CONFIG,Integer.toString(64*1024));
    ...
    public static void main(String[] args) throws IOException {
        HighThroughputProducer idempotentProducer = new HighThroughputProducer();
